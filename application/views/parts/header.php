                                ...
                                <div class="tabcontent" id="sign-phone">
                                    <div class="form-row">
                                        ...
                                        <label class="form-row-inner">
                                            <input type="tel" name="tel-number" maxlength="9" id="tel-number" class="input-text" required placeholder="+992 987654321">
                        ...
                        <div class="ps-block--user-header">
                            ...
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    <div class="image">
                                        <img src="{base_url}img/wolf.png" alt="User Icon" />
                                    </div>
                                    <div class="account-dropdown js-dropdown">
                                        <div class="info clearfix">
                                            ...
                                            <div class="content">
                                                <h5 class="name">
                                                    <a href="#">Amirjon Rajabov</a>
                                                </h5>
                                                <span class="email">info@admin.tj</span>
                                            </div>
                                        </div>
  ...
  <style>
    ...
    <script>
        ...
        function onPsBlockRight() {
            ...
            $(".enter-btn-bg").style.display = "flex";
            $(".enter-btn-bg").classList.add("active-animation");
            $(".enter-btn-bg").classList.remove("disactive-animation");
        }
