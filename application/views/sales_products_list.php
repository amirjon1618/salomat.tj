                    ...
                    <div class="ps-product">
                        ...
                        <div class="ps-product__container">
                            <div class="ps-product__content">
                                ...
                                <p class="ps-product__price sale prods_slider"><span><?= $cat_p['product_price'] ?> c.</span> <?php if ($cat_p['product_old_price'] != 0) : ?> <del><?= $cat_p['product_old_price'] ?> </del><?php endif; ?></p>
                            </div>
                            <div class="ps-product__content hover"><a class="ps-product__title" href="{base_url}main/product/<?= $cat_p['id'] ?>/<?= $cat_p['category_id'] ?>"><?= $cat_p['product_name'] ?></a>
                                <!-- <p class="ps-product__price sale"><?= $cat_p['product_price'] ?> <?php if ($cat_p['product_old_price'] != 0) : ?> <del><?= $cat_p['product_old_price'] ?> </del><?php endif; ?></p> -->
                                    <p class="ps-product__price sale prods_slider"><span><?= $cat_p['product_price'] ?> c.</span> <?php if ($cat_p['product_old_price'] != 0) : ?> <del><?= $cat_p['product_old_price'] ?> </del><?php endif; ?></p>
                            </div>
                        </div>
                    </div>
