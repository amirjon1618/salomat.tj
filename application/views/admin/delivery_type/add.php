        ...
        <div class="box-body">
            ...
            <!-- text input -->
                <div class="form-group">
                    ...
                    <input type="text" id="delivery_type_name" name="delivery_type_name" class="form-control" placeholder="Вводите ..." >
                </div>
                <div class="form-group">
                    <label>Адрес </label>
                    <input type="text" id="delivery_type_address" name="delivery_type_address" class="form-control" placeholder="Вводите ..." >
                </div>
