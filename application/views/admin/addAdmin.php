    ...
    <link rel="stylesheet" href="{base_url}plugins/iCheck/all.css">   
     <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{base_url}index.php/admin/admins"><i class="fa fa-list"></i> Пользователи</a></li>
                ...
                <div class="box-body pad">
                  <form action="" method="post" onsubmit="return tryReg();" role="form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="10" class="form-control" name="login" id="login">
                    </div>
                    <div class="form-group">
                      <label>Имя:</label>
                      <input type="text" maxlength="40" class="form-control" name="name" id="name">
                    </div>
                    <div class="form-group">
