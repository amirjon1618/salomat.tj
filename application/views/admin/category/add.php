...
<ol class="breadcrumb">
    ...
    <?php else: ?>
        <li><a href="{base_url}admin/categories"><i class="fa fa-dashboard"></i> Категории</a></li>
<!--        <li><a href="{base_url}admin/subCategories/--><?php //echo $parent_category['id'] ?><!--"><i class="fa fa-dashboard"></i> --><?php //echo $parent_category['category_name'] ?><!--</a></li>-->
...
<!--                                      <option value="--><?php //echo $val['id']?><!--" disabled>-->
