<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo $active_substance[0]['tag_name'] ?></li>
                ...
                <div class="box-body">
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo $active_substance[0]['tag_name'] ?>" type="text"
                                   id="active_substance_name" name="active_substance_name" class="form-control"
                                   placeholder="Вводите ...">
                        </div>
