					  ...
					  <form role="form" action="" onsubmit="return onsub();" method="POST">
						...
						<div class="form-group">
						  <label>В какой склад</label>
							<select id="delivery_to" name="delivery_to" class="form-control">
								<option value="0">Выберите</option>
								{delivery_to_list}
								<option value="{id}">{delivery_to_name}</option>
								{/delivery_to_list}
							</select>
						</div>
						<div class="form-group">
						  <label>Цена</label>
							<input value="{delivery_unit_price}" type="number" onkeyup="calc();" step="0.01" id="delivery_unit_price" name="delivery_unit_price" class="form-control" placeholder="Цена" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						  <label>Цена доставки</label>
							<input value="{delivery_price}" type="number" step="0.01" id="delivery_price" name="delivery_price" class="form-control" placeholder="Цена за доставку" >
						</div>
