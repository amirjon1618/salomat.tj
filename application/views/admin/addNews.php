					...
					<div class="col-md-6">
							...
							<div class="box-body pad">
								...
								<div class="form-group">
									...
									<input type="text" maxlength="150" class="form-control" name="news_title" id="news_title" placeholder="Title">
								...
								<div class="form-group">
									...
									<input type="hidden" name="news_poster" id="news_poster" />

									<img class="img-responsive" src="{base_url}images/no-image-available.jpg" id="poster"  />
								...
								<div class="form-group">
									...
									<input type="text" maxlength="250" class="form-control" name="news_text_cut" id="news_text_cut" placeholder="Cut">
								...
								<div class="form-group">
									...
									<div  class="scrollbars" id="news_text" style="padding: 3px;border-color: #dcd7d7;background-color: white;border-width:1px;border-style:solid;width: 100%;height: 600px;" contenteditable="true"></div>
								...
								<div class="box-footer">
									...
									<input type="button" onclick="submit_form()" name="AddBtn1" value="Создать" class="btn btn-primary pull-right" />
